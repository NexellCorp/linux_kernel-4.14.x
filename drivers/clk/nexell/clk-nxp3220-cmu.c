...
#define GATE_SYS_NP(_id, cname, pname, o, b, f, gf)		\
	GATE_NP(_id, cname, pname, o, o + 0x10, b, f, gf)

static const struct nexell_gate_clock sys_gate_clks[] __initconst = {
	GATE_SYS(CLK_SYS0_AXI, "sys0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 0, 0, 0),
	GATE_SYS(CLK_SYS_BUS0_AXI, "sys_bus0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 1, 0, 0),
	GATE_SYS(CLK_ETC_BUS0_AXI, "etc_bus0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 2, 0, 0),
	GATE_SYS(CLK_FSYS_BUS0_AXI, "fsys_bus0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 3, 0, 0),
	GATE_SYS(CLK_DMA_BUS0_AXI, "dma_bus0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 4, 0, 0),
	GATE_SYS(CLK_CFG_BUS0_AXI, "cfg_bus0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 5, 0, 0),
	GATE_SYS(CLK_AXISRAM0_AXI, "axisram0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 6, 0, 0),
	GATE_SYS(CLK_MP2TSI0_AXI, "mp2tsi0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 7, 0, 0),
	...
	GATE_SYS(CLK_DMA1_AXI, "dma1_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 12, 0, 0),
	GATE_SYS(CLK_SDMA0_AXI, "sdma0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 13, 0, 0),
	GATE_SYS(CLK_SDMA1_AXI, "sdma1_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 14, 0, 0),
	GATE_SYS(CLK_MDMA0_AXI, "mdma0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 15, 0, 0),
	GATE_SYS(CLK_SDMMC0_AXI, "sdmmc0_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 16, 0, 0),
	GATE_SYS(CLK_SDMMC1_AXI, "sdmmc1_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 17, 0, 0),
	GATE_SYS(CLK_SDMMC2_AXI, "sdmmc2_axi", "div_sys_sys0_axi",
		  SYS0_AXI + 0x10, 18, 0, 0),

	GATE_SYS(CLK_SYS0_APB, "sys0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 19, 0, 0),
	GATE_SYS(CLK_DPC_PAD_PLACE0, "dpc_pad_place0", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 20, 0, 0),
	GATE_SYS(CLK_I2S0_APB, "i2s0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 21, 0, 0),
	GATE_SYS(CLK_I2S1_APB, "i2s1_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 22, 0, 0),
	GATE_SYS(CLK_I2S2_APB, "i2s2_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 23, 0, 0),
	GATE_SYS(CLK_I2S3_APB, "i2s3_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 24, 0, 0),
	GATE_SYS(CLK_MP2TSI0_APB, "mp2tsi0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 25, 0, 0),
	GATE_SYS(CLK_MP2TSI1_APB, "mp2tsi1_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 26, 0, 0),
	GATE_SYS(CLK_WDT0_APB, "wdt0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 27, 0, 0),
	GATE_SYS(CLK_WDT0_POR, "wdt0_por", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 28, 0, 0),
	GATE_SYS(CLK_SECURE_WDT0_APB, "secure_wdt0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 29, 0, 0),
	GATE_SYS(CLK_SECURE_WDT0_POR, "secure_wdt0_por", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 30, 0, 0),
	GATE_SYS(CLK_SYSREG_SYS0_APB, "sysreg_sys0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x10, 31, 0, 0),

	GATE_SYS(CLK_ECID0_APB, "ecid0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 0, 0, 0),
	GATE_SYS(CLK_SYSCTRL_TOP_APB, "sysctrl_top_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 1, 0, 0),
	GATE_SYS(CLK_CAN0_APB, "can0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 2, 0, 0),
	...
	GATE_SYS(CLK_SSS0_APB, "sss0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 6, 0, 0),
	GATE_SYS(CLK_DMA1_APB, "dma1_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 7, 0, 0),
	GATE_SYS(CLK_SMC0_APB, "smc0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 8, 0, 0),
	GATE_SYS(CLK_GPIO0_APB, "gpio0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 9, 0, 0),
	GATE_SYS(CLK_SDMA0_APB, "sdma0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 10, 0, 0),
	GATE_SYS(CLK_GPIO1_APB, "gpio1_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 11, 0, 0),
	GATE_SYS(CLK_SDMA1_APB, "sdma1_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 12, 0, 0),
	GATE_SYS(CLK_GPIO2_APB, "gpio2_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 13, 0, 0),
	GATE_SYS(CLK_GPIO3_APB, "gpio3_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 14, 0, 0),
	GATE_SYS(CLK_GPIO4_APB, "gpio4_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 15, 0, 0),
	GATE_SYS(CLK_ADC0_APB, "adc0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 16, 0, 0),
	GATE_SYS(CLK_MDMA0_APB, "mdma0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 17, 0, 0),
	GATE_SYS(CLK_DUMMY0_APB, "dummy0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 18, 0, 0),
	GATE_SYS(CLK_SPDIFTX0_APB, "spdiftx0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 19, 0, 0),
	GATE_SYS(CLK_SPDIFRX0_APB, "spdifrx0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 20, 0, 0),
	GATE_SYS(CLK_SDMMC0_APB, "sdmmc0_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 21, 0, 0),
	GATE_SYS(CLK_SDMMC1_APB, "sdmmc1_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 22, 0, 0),
	GATE_SYS(CLK_SDMMC2_APB, "sdmmc2_apb", "div_sys_sys0_apb",
		  SYS0_AXI + 0x14, 23, 0, 0),

	GATE_SYS(CLK_SYS0_HSIF_AXI, "sys0_hsif_axi", "div_sys_sys0_hsif_axi",
		  SYS0_HSIF_AXI + 0x10, 0, 0, 0),
	GATE_SYS(CLK_BLK_HSIF_DATA_BUS0_AXI, "blk_hsif_data_bus0_axi",
		  "div_sys_sys0_hsif_axi",
		  SYS0_HSIF_AXI + 0x10, 1, 0, 0),
	GATE_SYS(CLK_SDMMC0_AHB, "sdmmc0_ahb", "div_sys_sys0_hsif_axi",
		  SYS0_HSIF_AXI + 0x10, 2, 0, 0),
	GATE_SYS(CLK_SDMMC1_AHB, "sdmmc1_ahb", "div_sys_sys0_hsif_axi",
		  SYS0_HSIF_AXI + 0x10, 3, 0, 0),
	GATE_SYS(CLK_SDMMC2_AHB, "sdmmc2_ahb", "div_sys_sys0_hsif_axi",
		  SYS0_HSIF_AXI + 0x10, 4, 0, 0),
	GATE_SYS(CLK_GMAC_RGMII0_AXI, "gmac_rgmii0_axi", "div_sys_sys0_hsif_axi",
		  SYS0_HSIF_AXI + 0x10, 5, 0, 0),
	GATE_SYS(CLK_GMAC_RMII0_AXI, "gmac_rmii0_axi", "div_sys_sys0_hsif_axi",
		  SYS0_HSIF_AXI + 0x10, 6, 0, 0),

	GATE_SYS(CLK_SYS0_HSIF_APB, "sys0_hsif_apb", "div_sys_sys0_hsif_apb",
		  SYS0_HSIF_AXI + 0x10, 7, 0, 0),
	GATE_SYS(CLK_BLK_HSIF_DATA_BUS0_APB, "blk_hsif_data_bus0_apb",
		  "div_sys_sys0_hsif_apb",
		  SYS0_HSIF_AXI + 0x10, 8, 0, 0),
	GATE_SYS(CLK_HSIF0_APB, "hsif0_apb", "div_sys_sys0_hsif_apb",
		  SYS0_HSIF_AXI + 0x10, 9, 0, 0),
	GATE_SYS(CLK_SYSREG_HSIF0_APB, "sysreg_hsif0_apb", "div_sys_sys0_hsif_apb",
		  SYS0_HSIF_AXI + 0x10, 10, 0, 0),
	GATE_SYS(CLK_GMAC_RGMII0_APB, "gmac_rgmii0_apb", "div_sys_sys0_hsif_apb",
		  SYS0_HSIF_AXI + 0x10, 11, 0, 0),
	GATE_SYS(CLK_GMAC_RMII0_APB, "gmac_rmii0_apb", "div_sys_sys0_hsif_apb",
		  SYS0_HSIF_AXI + 0x10, 12, 0, 0),
	GATE_SYS(CLK_NANDC0_APB, "nandc0_apb", "div_sys_sys0_hsif_apb",
