...
static const struct nexell_composite_clock src_clks[] __initconst = {
	{
		...
		COMP_BASE_SRC_CRIT(CLK_SRC_SYS0_HSIF_AXI, "src_sys0_hsif_axi")
		...
		COMP_BASE_FXD(CLK_SRC_UART0_CORE, "src_uart0_core", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(UART0_CORE)
		COMP_DIV_SRC(UART0_CORE)
		COMP_GATE_SRC(UART0_CORE)
	}, {
		COMP_BASE_FXD(CLK_SRC_UART0_APB, "src_uart_apb", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(UART0_APB)
		COMP_DIV_SRC(UART0_APB)
		COMP_GATE_SRC(UART0_APB)
	}, {
		COMP_BASE_FXD(CLK_SRC_I2S0_CORE, "src_i2s0_core", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(I2S0_CORE)
		COMP_DIV_SRC_F(I2S0_CORE, CLK_DIVIDER_ROUND_CLOSEST)
		COMP_GATE_SRC(I2S0_CORE)
	}, {
		COMP_BASE_FXD(CLK_SRC_I2S1_CORE, "src_i2s1_core", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(I2S1_CORE)
		COMP_DIV_SRC_F(I2S1_CORE, CLK_DIVIDER_ROUND_CLOSEST)
		COMP_GATE_SRC(I2S1_CORE)
	}, {
		COMP_BASE_FXD(CLK_SRC_I2S2_CORE, "src_i2s2_core", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(I2S2_CORE)
		COMP_DIV_SRC_F(I2S2_CORE, CLK_DIVIDER_ROUND_CLOSEST)
		COMP_GATE_SRC(I2S2_CORE)
	}, {
		COMP_BASE_FXD(CLK_SRC_I2S3_CORE, "src_i2s3_core", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(I2S3_CORE)
		COMP_DIV_SRC_F(I2S3_CORE, CLK_DIVIDER_ROUND_CLOSEST)
		COMP_GATE_SRC(I2S3_CORE)
	}, {
		COMP_BASE_FXD(CLK_SRC_I2C0_APB, "src_i2c0_apb", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(I2C0_APB)
		...
		COMP_BASE_FXD(CLK_SRC_SPI0_APB, "src_spi0_apb", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(SPI0_APB)
		COMP_DIV_SRC(SPI0_APB)
		COMP_GATE_SRC(SPI0_APB)
	}, {
		COMP_BASE_FXD(CLK_SRC_SPI0_CORE, "src_spi0_core", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(SPI0_CORE)
		...
		COMP_BASE_FXD(CLK_SRC_PWM0_APB, "src_pwm0_apb", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(PWM0_APB)
		COMP_DIV_SRC(PWM0_APB)
		COMP_GATE_SRC(PWM0_APB)
	}, {
		COMP_BASE_FXD(CLK_SRC_PWM0_TCLK0, "src_pwm0_tclk0", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(PWM0_TCLK0)
		COMP_DIV_SRC(PWM0_TCLK0)
		COMP_GATE_SRC(PWM0_TCLK0)
	}, {
		COMP_BASE_FXD(CLK_SRC_PWM0_TCLK1, "src_pwm0_tclk1", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(PWM0_TCLK1)
		COMP_DIV_SRC(PWM0_TCLK1)
		COMP_GATE_SRC(PWM0_TCLK1)
	}, {
		COMP_BASE_FXD(CLK_SRC_PWM0_TCLK2, "src_pwm0_tclk2", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(PWM0_TCLK2)
		COMP_DIV_SRC(PWM0_TCLK2)
		COMP_GATE_SRC(PWM0_TCLK2)
	}, {
		COMP_BASE_FXD(CLK_SRC_PWM0_TCLK3, "src_pwm0_tclk3", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(PWM0_TCLK3)
		COMP_DIV_SRC(PWM0_TCLK3)
		COMP_GATE_SRC(PWM0_TCLK3)
	}, {
		COMP_BASE_FXD(CLK_SRC_CAN0_CORE, "src_can0_core", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(CAN0_CORE)
		COMP_DIV_SRC(CAN0_CORE)
		COMP_GATE_SRC(CAN0_CORE)
	}, {
		COMP_BASE_FXD(CLK_SRC_CAN1_CORE, "src_can1_core", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(CAN1_CORE)
		COMP_DIV_SRC(CAN1_CORE)
		COMP_GATE_SRC(CAN1_CORE)
	}, {
		COMP_BASE_FXD(CLK_SRC_TIMER0_APB, "src_timer0_apb", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(TIMER0_APB)
		COMP_DIV_SRC(TIMER0_APB)
		COMP_GATE_SRC(TIMER0_APB)
	}, {
		COMP_BASE_FXD(CLK_SRC_TIMER0_TCLK0, "src_timer0_tclk0", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(TIMER0_TCLK0)
		COMP_DIV_SRC(TIMER0_TCLK0)
		COMP_GATE_SRC(TIMER0_TCLK0)
	}, {
		COMP_BASE_FXD(CLK_SRC_TIMER0_TCLK1, "src_timer0_tclk1", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(TIMER0_TCLK1)
		COMP_DIV_SRC(TIMER0_TCLK1)
		COMP_GATE_SRC(TIMER0_TCLK1)
	}, {
		COMP_BASE_FXD(CLK_SRC_TIMER0_TCLK2, "src_timer0_tclk2", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(TIMER0_TCLK2)
		COMP_DIV_SRC(TIMER0_TCLK2)
		COMP_GATE_SRC(TIMER0_TCLK2)
	}, {
		COMP_BASE_FXD(CLK_SRC_TIMER0_TCLK3, "src_timer0_tclk3", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_FXD(TIMER0_TCLK3)
		...
		COMP_BASE_CODA(CLK_SRC_GMAC_RGMII0_TX, "src_gmac_rgmii0_tx", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_CODA(GMAC_RGMII0_TX)
		COMP_DIV_SRC(GMAC_RGMII0_TX)
		COMP_GATE_SRC(GMAC_RGMII0_TX)
	}, {
		COMP_BASE_CODA(CLK_SRC_GMAC_RGMII0_PTP_REF, "src_gmac_rgmii0_ptp_ref", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_CODA(GMAC_RGMII0_PTP_REF)
		COMP_DIV_SRC(GMAC_RGMII0_PTP_REF)
		COMP_GATE_SRC(GMAC_RGMII0_PTP_REF)
	}, {
		COMP_BASE_CODA(CLK_SRC_GMAC_RMII0_PTP_REF, "src_gmac_rmii0_ptp_ref", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_CODA(GMAC_RMII0_PTP_REF)
		...
		COMP_BASE_CORE(CLK_SRC_DPC0_X2, "src_dpc0_x2", CLK_DIVIDER_ROUND_CLOSEST)
		COMP_MUX_CORE(DPC0_X2)
