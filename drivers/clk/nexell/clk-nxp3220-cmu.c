...
#define COMP_BASE_SRC(_id, cname) \
	COMP_BASE(_id, NULL, cname, src_mux_p, 0)
...
#define COMP_GATE_SRC(o) \
	COMP_GATE(o + 0x10, 0, 0)

static const struct nexell_composite_clock src_clks[] __initconst = {
	{
		COMP_BASE_SRC(CLK_SRC_SYS0_AXI, "src_sys0_axi")
		...
		COMP_BASE_SRC(CLK_SRC_MM0_AXI, "src_mm0_axi")
		COMP_MUX_SRC(MM0_AXI)
		COMP_DIV_SRC(MM0_AXI)
		COMP_GATE_SRC(MM0_AXI)
	}, {
		COMP_BASE_SRC(CLK_SRC_VIP0_PADOUT0, "src_vip0_padout0")
		COMP_MUX_SRC(VIP0_PADOUT0)
		COMP_DIV_SRC(VIP0_PADOUT0)
		COMP_GATE_SRC(VIP0_PADOUT0)
	}, {
		COMP_BASE_SRC(CLK_SRC_VIP0_PADOUT1, "src_vip0_padout1")
		...
		COMP_BASE_SRC(CLK_SRC_CODA960_0_CORE, "src_coda960_0_core")
...
static const struct nexell_gate_clock sys_gate_clks[] __initconst = {
	GATE(CLK_SYS0_AXI, "sys0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 0, 0, 0),
	GATE(CLK_SYS_BUS0_AXI, "sys_bus0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 1, 0, 0),
	GATE(CLK_ETC_BUS0_AXI, "etc_bus0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 2, 0, 0),
	GATE(CLK_FSYS_BUS0_AXI, "fsys_bus0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 3, 0, 0),
	GATE(CLK_DMA_BUS0_AXI, "dma_bus0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 4, 0, 0),
	GATE(CLK_CFG_BUS0_AXI, "cfg_bus0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 5, 0, 0),
	GATE(CLK_AXISRAM0_AXI, "axisram0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 6, 0, 0),
	GATE(CLK_MP2TSI0_AXI, "mp2tsi0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 7, 0, 0),
	GATE(CLK_MP2TSI1_AXI, "mp2tsi1_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 8, 0, 0),
	GATE(CLK_TOP_BIST0_AXI, "top_bist0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 9, 0, 0),
	GATE(CLK_DMA0_AXI, "dma0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 10, 0, 0),
	GATE(CLK_SSS0_AXI, "sss0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 11, 0, 0),
	GATE(CLK_DMA1_AXI, "dma1_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 12, 0, 0),
	GATE(CLK_SDMA0_AXI, "sdma0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 13, 0, 0),
	GATE(CLK_SDMA1_AXI, "sdma1_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 14, 0, 0),
	GATE(CLK_MDMA0_AXI, "mdma0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 15, 0, 0),
	GATE(CLK_SDMMC0_AXI, "sdmmc0_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 16, 0, 0),
	GATE(CLK_SDMMC1_AXI, "sdmmc1_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 17, 0, 0),
	GATE(CLK_SDMMC2_AXI, "sdmmc2_axi", "div_sys_sys0_axi",
	     SYS0_AXI + 0x10, 18, 0, 0),

	GATE(CLK_SYS0_APB, "sys0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 19, 0, 0),
	GATE(CLK_DPC_PAD_PLACE0, "dpc_pad_place0", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 20, 0, 0),
	GATE(CLK_I2S0_APB, "i2s0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 21, 0, 0),
	GATE(CLK_I2S1_APB, "i2s1_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 22, 0, 0),
	GATE(CLK_I2S2_APB, "i2s2_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 23, 0, 0),
	GATE(CLK_I2S3_APB, "i2s3_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 24, 0, 0),
	GATE(CLK_MP2TSI0_APB, "mp2tsi0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 25, 0, 0),
	GATE(CLK_MP2TSI1_APB, "mp2tsi1_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 26, 0, 0),
	GATE(CLK_WDT0_APB, "wdt0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 27, 0, 0),
	GATE(CLK_WDT0_POR, "wdt0_por", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 28, 0, 0),
	GATE(CLK_SECURE_WDT0_APB, "secure_wdt0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 29, 0, 0),
	GATE(CLK_SECURE_WDT0_POR, "secure_wdt0_por", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 30, 0, 0),
	GATE(CLK_SYSREG_SYS0_APB, "sysreg_sys0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x10, 31, 0, 0),

	GATE(CLK_ECID0_APB, "ecid0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 0, 0, 0),
	GATE(CLK_SYSCTRL_TOP_APB, "sysctrl_top_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 1, 0, 0),
	GATE(CLK_CAN0_APB, "can0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 2, 0, 0),
	GATE(CLK_CAN1_APB, "can1_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 3, 0, 0),
	GATE(CLK_TMU0_APB, "tmu0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 4, 0, 0),
	GATE(CLK_DMA0_APB, "dma0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 5, 0, 0),
	GATE(CLK_SSS0_APB, "sss0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 6, 0, 0),
	GATE(CLK_DMA1_APB, "dma1_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 7, 0, 0),
	GATE(CLK_SMC0_APB, "smc0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 8, 0, 0),
	GATE(CLK_GPIO0_APB, "gpio0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 9, 0, 0),
	GATE(CLK_SDMA0_APB, "sdma0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 10, 0, 0),
	GATE(CLK_GPIO1_APB, "gpio1_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 11, 0, 0),
	GATE(CLK_SDMA1_APB, "sdma1_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 12, 0, 0),
	GATE(CLK_GPIO2_APB, "gpio2_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 13, 0, 0),
	GATE(CLK_GPIO3_APB, "gpio3_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 14, 0, 0),
	GATE(CLK_GPIO4_APB, "gpio4_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 15, 0, 0),
	GATE(CLK_ADC0_APB, "adc0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 16, 0, 0),
	GATE(CLK_MDMA0_APB, "mdma0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 17, 0, 0),
	GATE(CLK_DUMMY0_APB, "dummy0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 18, 0, 0),
	GATE(CLK_SPDIFTX0_APB, "spdiftx0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 19, 0, 0),
	GATE(CLK_SPDIFRX0_APB, "spdifrx0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 20, 0, 0),
	GATE(CLK_SDMMC0_APB, "sdmmc0_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 21, 0, 0),
	GATE(CLK_SDMMC1_APB, "sdmmc1_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 22, 0, 0),
	GATE(CLK_SDMMC2_APB, "sdmmc2_apb", "div_sys_sys0_apb",
	     SYS0_AXI + 0x14, 23, 0, 0),

	GATE(CLK_SYS0_HSIF_AXI, "sys0_hsif_axi", "div_sys_sys0_hsif_axi",
	     SYS0_HSIF_AXI + 0x10, 0, 0, 0),
	GATE(CLK_BLK_HSIF_DATA_BUS0_AXI, "blk_hsif_data_bus0_axi",
	     "div_sys_sys0_hsif_axi",
	     SYS0_HSIF_AXI + 0x10, 1, 0, 0),
	GATE(CLK_SDMMC0_AHB, "sdmmc0_ahb", "div_sys_sys0_hsif_axi",
	     SYS0_HSIF_AXI + 0x10, 2, 0, 0),
	GATE(CLK_SDMMC1_AHB, "sdmmc1_ahb", "div_sys_sys0_hsif_axi",
	     SYS0_HSIF_AXI + 0x10, 3, 0, 0),
	GATE(CLK_SDMMC2_AHB, "sdmmc2_ahb", "div_sys_sys0_hsif_axi",
	     SYS0_HSIF_AXI + 0x10, 4, 0, 0),
	GATE(CLK_GMAC_RGMII0_AXI, "gmac_rgmii0_axi", "div_sys_sys0_hsif_axi",
	     SYS0_HSIF_AXI + 0x10, 5, 0, 0),
	GATE(CLK_GMAC_RMII0_AXI, "gmac_rmii0_axi", "div_sys_sys0_hsif_axi",
	     SYS0_HSIF_AXI + 0x10, 6, 0, 0),

	GATE(CLK_SYS0_HSIF_APB, "sys0_hsif_apb", "div_sys_sys0_hsif_apb",
	     SYS0_HSIF_AXI + 0x10, 7, 0, 0),
	GATE(CLK_BLK_HSIF_DATA_BUS0_APB, "blk_hsif_data_bus0_apb",
	     "div_sys_sys0_hsif_apb",
	     SYS0_HSIF_AXI + 0x10, 8, 0, 0),
	GATE(CLK_HSIF0_APB, "hsif0_apb", "div_sys_sys0_hsif_apb",
	     SYS0_HSIF_AXI + 0x10, 9, 0, 0),
	GATE(CLK_SYSREG_HSIF0_APB, "sysreg_hsif0_apb", "div_sys_sys0_hsif_apb",
	     SYS0_HSIF_AXI + 0x10, 10, 0, 0),
	GATE(CLK_GMAC_RGMII0_APB, "gmac_rgmii0_apb", "div_sys_sys0_hsif_apb",
	     SYS0_HSIF_AXI + 0x10, 11, 0, 0),
	GATE(CLK_GMAC_RMII0_APB, "gmac_rmii0_apb", "div_sys_sys0_hsif_apb",
	     SYS0_HSIF_AXI + 0x10, 12, 0, 0),
	GATE(CLK_NANDC0_APB, "nandc0_apb", "div_sys_sys0_hsif_apb",
	     SYS0_HSIF_AXI + 0x10, 13, 0, 0),
	GATE(CLK_CPU_BACKUP0, "cpu_backup0", "div_sys_cpu_backup0",
	     CPU_BACKUP0 + 0x10, 0, 0, 0),
	GATE(CLK_CSSYS0_HCLK, "cssys0_hclk",
		"div_sys_cssys0_hclk", CSSYS0_HCLK + 0x10, 0, 0, 0),
	GATE(CLK_CSSYS0_SCAN, "cssys0_scan",
		"div_sys_cssys0_scan", CSSYS0_SCAN + 0x10, 0, 0, 0),
	GATE(CLK_BLK_CMU0_APB, "blk_cmu0_apb",
		"div_sys_blk_cmu0_apb", BLK_CMU0_APB + 0x10, 0, 0, 0),
	GATE(CLK_VIP_PADPLACE0_SCAN, "vip_padplace0_scan",
		"div_sys_vip_padplace0_scan", VIP_PADPLACE0_SCAN + 0x10,
		0, 0, 0),
	GATE(CLK_VIP_PADOUT0, "vip_padout0",
		"div_sys_vip_padout0", VIP_PADOUT0 + 0x10, 0, 0, 0),
	GATE(CLK_VIP_PADOUT1, "vip_padout1",
		"div_sys_vip_padout1", VIP_PADOUT1 + 0x10, 0, 0, 0),
	GATE(CLK_VIP_PADOUT2, "vip_padout2",
		"div_sys_vip_padout2", VIP_PADOUT2 + 0x10, 0, 0, 0),
	GATE(CLK_VIP_PADOUT3, "vip_padout3",
		"div_sys_vip_padout3", VIP_PADOUT3 + 0x10, 0, 0, 0),
	GATE(CLK_VIP_PADOUT4, "vip_padout4",
		"div_sys_vip_padout4", VIP_PADOUT4 + 0x10, 0, 0, 0),
	GATE(CLK_HPM_SYS0, "hpm_sys0",
		"div_sys_hpm_sys0", HPM_SYS0 + 0x10, 0, 0, 0),
	GATE_NP(CLK_UART0_CORE, "uart0_core",
		"div_sys_uart0_core", UART0_CORE + 0x10, 0, 0, 0),
	GATE_NP(CLK_UART1_CORE, "uart1_core",
		"div_sys_uart0_core", UART0_CORE + 0x10, 1, 0, 0),
	GATE_NP(CLK_UART2_CORE, "uart2_core",
		"div_sys_uart0_core", UART0_CORE + 0x10, 2, 0, 0),
	GATE_NP(CLK_UART3_CORE, "uart3_core",
		"div_sys_uart0_core", UART0_CORE + 0x10, 3, 0, 0),
	GATE_NP(CLK_UART4_CORE, "uart4_core",
		"div_sys_uart0_core", UART0_CORE + 0x10, 4, 0, 0),
	GATE_NP(CLK_UART5_CORE, "uart5_core",
		"div_sys_uart0_core", UART0_CORE + 0x10, 5, 0, 0),
	GATE_NP(CLK_UART6_CORE, "uart6_core",
		"div_sys_uart0_core", UART0_CORE + 0x10, 6, 0, 0),
	GATE(CLK_UART0_APB, "uart0_apb",
		"div_sys_uart0_apb", UART0_APB + 0x10, 0, 0, 0),
	GATE(CLK_UART1_APB, "uart1_apb",
		"div_sys_uart0_apb", UART0_APB + 0x10, 1, 0, 0),
	GATE(CLK_UART2_APB, "uart2_apb",
		"div_sys_uart0_apb", UART0_APB + 0x10, 2, 0, 0),
	GATE(CLK_UART3_APB, "uart3_apb",
		"div_sys_uart0_apb", UART0_APB + 0x10, 3, 0, 0),
	GATE(CLK_UART4_APB, "uart4_apb",
		"div_sys_uart0_apb", UART0_APB + 0x10, 4, 0, 0),
	GATE(CLK_UART5_APB, "uart5_apb",
		"div_sys_uart0_apb", UART0_APB + 0x10, 5, 0, 0),
	GATE(CLK_UART6_APB, "uart6_apb",
		"div_sys_uart0_apb", UART0_APB + 0x10, 6, 0, 0),
	GATE(CLK_I2S0_SCAN, "i2s0_scan",
		"div_sys_i2s0_scan", I2S0_SCAN + 0x10, 0, 0, 0),
	GATE(CLK_I2S1_SCAN, "i2s1_scan",
		"div_sys_i2s0_scan", I2S0_SCAN + 0x10, 1, 0, 0),
	GATE(CLK_I2S2_SCAN, "i2s2_scan",
		"div_sys_i2s0_scan", I2S0_SCAN + 0x10, 2, 0, 0),
	GATE(CLK_I2S3_SCAN, "i2s3_scan",
		"div_sys_i2s0_scan", I2S0_SCAN + 0x10, 3, 0, 0),
	GATE(CLK_I2S0_CORE, "i2s0_core",
		"div_sys_i2s0_core", I2S0_CORE + 0x10, 0, 0, 0),
	GATE(CLK_I2S1_CORE, "i2s1_core",
		"div_sys_i2s1_core", I2S1_CORE + 0x10, 0, 0, 0),
	GATE(CLK_I2S2_CORE, "i2s2_core",
		"div_sys_i2s2_core", I2S2_CORE + 0x10, 0, 0, 0),
	GATE(CLK_I2S3_CORE, "i2s3_core",
		"div_sys_i2s3_core", I2S3_CORE + 0x10, 0, 0, 0),
	GATE(CLK_I2C0_APB, "i2c0_apb",
		"div_sys_i2c0_apb", I2C0_APB + 0x10, 0, 0, 0),
	GATE(CLK_I2C1_APB, "i2c1_apb",
		"div_sys_i2c0_apb", I2C0_APB + 0x10, 1, 0, 0),
	GATE(CLK_I2C2_APB, "i2c2_apb",
		"div_sys_i2c0_apb", I2C0_APB + 0x10, 2, 0, 0),
	GATE(CLK_I2C3_APB, "i2c3_apb",
		"div_sys_i2c0_apb", I2C0_APB + 0x10, 3, 0, 0),
	GATE(CLK_I2C4_APB, "i2c4_apb",
		"div_sys_i2c0_apb", I2C0_APB + 0x10, 4, 0, 0),
	GATE(CLK_MP2TSI0_SCAN, "mp2tsi0_scan",
		"div_sys_mp2tsi0_scan", MP2TSI0_SCAN + 0x10, 0, 0, 0),
	GATE(CLK_MP2TSI1_SCAN, "mp2tsi1_scan",
		"div_sys_mp2tsi0_scan", MP2TSI0_SCAN + 0x10, 1, 0, 0),
	GATE(CLK_SDMMC0_SCAN, "sdmmc0_scan",
		"div_sys_sdmmc0_scan", SDMMC0_SCAN + 0x10, 0, 0, 0),
	GATE(CLK_SDMMC1_SCAN, "sdmmc1_scan",
		"div_sys_sdmmc0_scan", SDMMC0_SCAN + 0x10, 1, 0, 0),
	GATE(CLK_SDMMC2_SCAN, "sdmmc2_scan",
		"div_sys_sdmmc0_scan", SDMMC0_SCAN + 0x10, 2, 0, 0),
	GATE(CLK_SDMMC0_CORE, "sdmmc0_core",
		"div_sys_sdmmc0_core", SDMMC0_CORE + 0x10, 0, 0, 0),
	GATE(CLK_SDMMC1_CORE, "sdmmc1_core",
		"div_sys_sdmmc1_core", SDMMC1_CORE + 0x10, 0, 0, 0),
	GATE(CLK_SDMMC2_CORE, "sdmmc2_core",
		"div_sys_sdmmc2_core", SDMMC2_CORE + 0x10, 0, 0, 0),
	GATE(CLK_SPI0_APB, "spi0_apb",
		"div_sys_spi0_apb", SPI0_APB + 0x10, 0, 0, 0),
	GATE(CLK_SPI1_APB, "spi1_apb",
		"div_sys_spi0_apb", SPI0_APB + 0x10, 1, 0, 0),
	GATE(CLK_SPI2_APB, "spi2_apb",
		"div_sys_spi0_apb", SPI0_APB + 0x10, 2, 0, 0),
	GATE(CLK_SPI0_CORE, "spi0_core",
		"div_sys_spi0_core", SPI0_CORE + 0x10, 0, 0, 0),
	GATE(CLK_SPI1_CORE, "spi1_core",
		"div_sys_spi0_core", SPI0_CORE + 0x10, 1, 0, 0),
	GATE(CLK_SPI2_CORE, "spi2_core",
		"div_sys_spi0_core", SPI0_CORE + 0x10, 2, 0, 0),
	GATE(CLK_PDM0_AXI, "pdm0_axi",
		"div_sys_pdm0_axi", PDM0_AXI + 0x10, 0, 0, 0),
	GATE(CLK_PDM0_CORE, "pdm0_core",
		"div_sys_pdm0_core", PDM0_CORE + 0x10, 0, 0, 0),
	GATE(CLK_PWM0_APB, "pwm0_apb",
		"div_sys_pwm0_apb", PWM0_APB + 0x10, 0, 0, 0),
	GATE(CLK_PWM0_TCLK0, "pwm0_tclk0",
		"div_sys_pwm0_tclk0", PWM0_TCLK0 + 0x10, 0, 0, 0),
	GATE(CLK_PWM0_TCLK1, "pwm0_tclk1",
		"div_sys_pwm0_tclk1", PWM0_TCLK1 + 0x10, 0, 0, 0),
	GATE(CLK_PWM0_TCLK2, "pwm0_tclk2",
		"div_sys_pwm0_tclk2", PWM0_TCLK2 + 0x10, 0, 0, 0),
	GATE(CLK_PWM0_TCLK3, "pwm0_tclk3",
		"div_sys_pwm0_tclk3", PWM0_TCLK3 + 0x10, 0, 0, 0),
	GATE(CLK_CAN0_CORE, "can0_core",
		"div_sys_can0_core", CAN0_CORE + 0x10, 0, 0, 0),
	GATE(CLK_CAN1_CORE, "can1_core",
		"div_sys_can1_core", CAN1_CORE + 0x10, 0, 0, 0),
	GATE(CLK_TIMER0_APB, "timer0_apb",
		"div_sys_timer0_apb", TIMER0_APB + 0x10, 0, 0, 0),
	GATE(CLK_TIMER0_TCLK0, "timer0_tclk0",
		"div_sys_timer0_tclk0", TIMER0_TCLK0 + 0x10, 0, 0, 0),
	GATE(CLK_TIMER0_TCLK1, "timer0_tclk1",
		"div_sys_timer0_tclk1", TIMER0_TCLK1 + 0x10, 0, 0, 0),
	GATE(CLK_TIMER0_TCLK2, "timer0_tclk2",
		"div_sys_timer0_tclk2", TIMER0_TCLK2 + 0x10, 0, 0, 0),
	GATE(CLK_TIMER0_TCLK3, "timer0_tclk3",
		"div_sys_timer0_tclk3", TIMER0_TCLK3 + 0x10, 0, 0, 0),
	GATE(CLK_SECURE_TIMER0_APB, "secure_timer0_apb",
		"div_sys_secure_timer0_apb", SECURE_TIMER0_APB + 0x10,
		0, 0, 0),
	GATE(CLK_SECURE_TIMER0_TCLK0, "secure_timer0_tclk0",
		"div_sys_secure_timer0_tclk0", SECURE_TIMER0_TCLK0 + 0x10,
		0, 0, 0),
	GATE(CLK_SECURE_TIMER0_TCLK1, "secure_timer0_tclk1",
		"div_sys_secure_timer0_tclk1", SECURE_TIMER0_TCLK1 + 0x10,
		0, 0, 0),
	GATE(CLK_SECURE_TIMER0_TCLK2, "secure_timer0_tclk2",
		"div_sys_secure_timer0_tclk2", SECURE_TIMER0_TCLK2 + 0x10,
		0, 0, 0),
	GATE(CLK_SECURE_TIMER0_TCLK3, "secure_timer0_tclk3",
		"div_sys_secure_timer0_tclk3", SECURE_TIMER0_TCLK3 + 0x10,
		0, 0, 0),
	GATE(CLK_SMC0_AXI, "smc0_axi",
		"div_sys_smc0_axi", SMC0_AXI + 0x10, 0, 0, 0),
	GATE(CLK_SPDIFTX0_CORE, "spdiftx0_core",
		"div_sys_spdiftx0_core", SPDIFTX0_CORE + 0x10, 0, 0, 0),
	GATE(CLK_GMAC_RGMII0_TX, "gmac_rgmii0_tx",
		"div_sys_gmac_rgmii0_tx", GMAC_RGMII0_TX + 0x10, 0, 0, 0),
	GATE(CLK_GMAC_RGMII0_PTP_REF, "gmac_rgmii0_ptp_ref",
		"div_sys_gmac_rgmii0_ptp_ref", GMAC_RGMII0_PTP_REF + 0x10,
		0, 0, 0),
	GATE(CLK_GMAC_RGMII0_SCAN, "gmac_rgmii0_scan",
		"div_sys_gmac_rgmii0_scan", GMAC_RGMII0_SCAN + 0x10,
		0, 0, 0),
	GATE(CLK_GMAC_RMII0_PTP_REF, "gmac_rmii0_ptp_ref",
		"div_sys_gmac_rmii0_ptp_ref", GMAC_RMII0_PTP_REF + 0x10,
		0, 0, 0),
	GATE(CLK_GMAC_RMII0_SCAN, "gmac_rmii0_scan",
		"div_sys_gmac_rmii0_scan", GMAC_RMII0_SCAN + 0x10, 0, 0, 0),
	GATE(CLK_GMAC_RMII0_SCAN_TRX, "gmac_rmii0_scan_trx",
		"gmac_rmii0_scan", GMAC_RMII0_SCAN + 0x10, 1, 0, 0),
	GATE(CLK_NANDC0_AXI, "nandc0_axi",
...
static void __init nxp3220_cmu_init(struct device_node *np)
{
	...
	nexell_clk_register_composite(ctx, src_clks, ARRAY_SIZE(src_clks));

	/* Register CMU_SYS clocks */
	ctx->reg = sys_reg;

	nexell_clk_register_div(ctx, sys_div_clks, ARRAY_SIZE(sys_div_clks));
	nexell_clk_register_gate(ctx, sys_gate_clks,
